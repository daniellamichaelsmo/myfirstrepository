...
# #Else if shuttle_speed is < 8000, print "ALERT: Cannot maintain orbit!" Else print "Stable speed".
...
#The code blocks will both print "all systems go" because of the boolean logic used
    #block one has all trues which lead to 'if' - all systems go
    #block two has all negatives which lead to 'else' - all systems go

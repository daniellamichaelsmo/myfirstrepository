...
# e) If fuel_level is below 1000 OR engine_temperature is above 3500 OR engine_indicator_light 
...
# If command_override is false, then the shuttle should 
# only launch if the fuel and engine check are OK. If command_override is true, 
